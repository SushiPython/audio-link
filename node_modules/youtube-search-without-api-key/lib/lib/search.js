...
var rfc3986EncodeURIComponent = function (str) { return encodeURIComponent(str).replace(/[!'()*]/g, escape); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, got_1.default.get("".concat(YOUTUBE_URL, "/results?q=").concat(rfc3986EncodeURIComponent(searchQuery.trim()), "&hl=en"))];
                case 1:
                    searchRes = _a.sent();
